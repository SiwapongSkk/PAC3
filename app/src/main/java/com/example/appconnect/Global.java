...
public class Global {
    ...
    public static String sdkid_BPM = "vXJhWuU4ee$tJJ*G";
    public static String sdkid_BT = "o8%d5$H72k&Sji01";
    public static String sdkid_WBP = "a&Fz7OD7y?0zNF42";
    public static String sdkid_WEI = "V8iwa5V2L!=w=+K@";
